...
class OrderMapperTest {
    ...
    void orderDtoToOrder() {
        ...
        OrderDto orderDto = OrderDto.builder().id(ID)
                ...
                .check(OrderCheckDto.builder().build())
    ...
    void orderToOrderDto() {
        ...
        Order order = Order.builder()
                ...
                .shippingPriceInCents(BigDecimal.valueOf(28))
                .check(OrderCheck.builder().id(checkId).build())
                .orderType(OrderType.builder().id(typeId).build())
                .destination(Destination.builder().id(destinationId).build())
                .build();

        when(orderCheckMapper.orderCheckToOrderCheckDto(any())).thenReturn(OrderCheckDto.builder().id(checkId).build());
        ...
        assertEquals(order.getCheck().getId(), orderDto.getCheck().getId());
