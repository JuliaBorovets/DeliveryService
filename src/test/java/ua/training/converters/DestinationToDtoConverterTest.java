...
class DestinationToDtoConverterTest {
    ...
    DestinationToDtoConverter converter;

    @BeforeEach
    void setUp() {
        converter = new DestinationToDtoConverter();
    }
    ...
    void convert() {
        ...
        DestinationDto destinationDto = converter.convert(destination);
